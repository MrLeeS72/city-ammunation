...
import { FileCheck, Briefcase, FileText, Home } from 'lucide-react'
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <Button asChild>
          <Link href="/" className="flex items-center">
            <Home className="mr-2 h-4 w-4" /> Домой
          </Link>
        </Button>
      </div>
      
      <h1 className="text-3xl font-bold mb-6 text-red-600">Лицензирование</h1>
      ...
      <div className="mb-8">
        ...
        <ol className="list-decimal list-inside space-y-4">
          <li>Направиться в медицинский центр и получить медицинское заключение психолога об отсутствии у гражданина противопоказаний для владения огнестрельным оружием.</li>
          <li>Направиться в центральную "Ammu-Nation" и пройти теоретическое занятие по базовому обращению с оружием, после чего сдать теоретический и практический экзамен на основе пройденного курса.</li>
          <li>Направиться в удобный для Вас участок Полицейского департамента и получить бумажную лицензию государственного образца с водными знаками.</li>
        </ol>
      </div>
