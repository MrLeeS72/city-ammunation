  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-6 text-red-600">Тир</h1>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>К вашим услугам крытый тир в центральном отделение "Ammu-Nation" по адресу: Adam's Apple Boulevard 8168</p>
          </CardContent>
        </Card>
