...
const weaponCategories = [
  {
    ...
    items: [
      { name: "Выкидной нож", price: 320, image: "/images/flick-knife.png" },
      { name: "Армейский нож M9", price: 600, image: "/images/army-knife-m9.png" },
      { name: "Кавалерийский кинжал", price: 400, image: "/images/cavalry-dagger.png" },
      { name: "Мачете", price: 620, image: "/images/machete.png" },
      { name: "Кастет", price: 110, image: "/images/brass-knuckles.png" },
      { name: "Бейсбольная бита", price: 110, image: "/images/pinch-bar.png" },
      { name: "Клюшка для гольфа", price: 320, image: "/images/golf-hockey-stick.png" },
      { name: "Бильярдный кий", price: 70, image: "/images/billiard-cue.png" },
      { name: "Молоток", price: 180, image: "/images/hammer.png" },
      { name: "Монтировка", price: 470, image: "/images/crowbar.png" },
      { name: "Развадной ключ", price: 380, image: "/images/adjustable-spanner.png" },
      { name: "Фонарик", price: 80, image: "/images/flashlight.png" },
      { name: "Топор", price: 300, image: "/images/axe.png" },
      { name: "Томагавк", price: 400, image: "/images/battle-axe.png" },
      { name: "Заправка огнетушителя", price: 105, image: "/images/fire-extinguisher-refill.png" },
      { name: "Канистра", price: 50, image: "/images/jerrycan.png" },
    ],
  },
  {
    name: 'Категория "9мм"',
    items: [
      { name: "Карманный пистолет", price: 1520, ammo: "Патроны 12шт/36$", image: "/images/pocket-pistol.png" },
      { name: "BERETTA M9", price: 2700, ammo: "Патроны 12шт/36$", image: "/images/beretta-m9.png" },
      { name: "SIG Sauer P250", price: 4200, ammo: "Патроны 12шт/36$", image: "/images/sig-sauer-p250.png" },
      { name: "Glock - 17", price: 5250, ammo: "Патроны 12шт/36$", image: "/images/glock-17.png" },
      { name: "Винтажный пистолет", price: 5700, ammo: "Патроны 12шт/36$", image: "/images/vintage-pistol.png" },
      { name: "Сигнальный пистолет", price: 2250, ammo: "Патроны 12шт/90$", image: "/images/orion-flare-gun.png" },
    ],
  },
  {
    name: 'Категория "A"',
    items: [
      { name: "Colt 1911", price: 6000, ammo: "Патроны 12шт/36$", image: "/images/colt1911.png" },
      { name: "DESERT EAGLE", price: 10200, ammo: "Патроны 12шт/36$", image: "/images/desert-eagle.png" },
      { name: "Револьвер", price: 30000, ammo: "Патроны 12шт/36$", image: "/images/revolver.png" },
      { name: "Револьвер MK II", price: 37000, ammo: "Патроны 12шт/36$", image: "/images/revolver-mk-ii.png" },
      { name: "Золотой револьвер", price: 50000, ammo: "Патроны 12шт/36$", image: "/images/gold-revolver.png" },
    ],
  },
  {
    name: 'Категория "B"',
    items: [
      { name: "MOSSBERG 590 A1", price: 15000, ammo: "Патроны 12шт/48$", image: "/images/mossberg-590-a1.png" },
      { name: "Укороченный дробовик Serbu", price: 9000, ammo: "Патроны 12шт/48$", image: "/images/serbu.png" },
      { name: "Обрез", price: 7000, ammo: "Патроны 12шт/48$", image: "/images/sawed-off-shotgun.png" },
      { name: "Мушкет", price: 4500, ammo: "Патроны 12шт/48$", image: "/images/flintlock-rifle.png" },
      { name: "Дуэльный пистолет", price: 5500, ammo: "Патроны 12шт/48$", image: "/images/contender.png" },
    ],
  },
  {
    name: 'Категория "C"',
    items: [
      { name: "TEC-9", price: 13000, ammo: "Патроны 12шт/48$", image: "/images/tec-9.png" },
      { name: "Скорпион", price: 16500, ammo: "Патроны 12шт/48$", image: "/images/skorpion.png" },
      { name: "FN P90", price: 15500, ammo: "Патроны 12шт/48$", image: "/images/fn-p90.png" },
      { name: "MP5", price: 15200, ammo: "Патроны 12шт/48$", image: "/images/mp5.png" },
      { name: "SGW Suppressor", price: 20200, ammo: "Патроны 12шт/48$", image: "/images/sgw-suppressor.png" },
      { name: "MP5 MKII", price: 23000, ammo: "Патроны 12шт/48$", image: "/images/mp5-mkii.png" },
      { name: "THOMPSON", price: 19250, ammo: "Патроны 12шт/48$", image: "/images/thompson.png" },
    ],
  },
  {
    name: 'Категория "D"',
    items: [
      { name: "AR-15/TX-15", price: 90000, ammo: "Патроны 12шт/48$", image: "/images/ar-15-tx-15.png" },
      { name: "AK", price: 32900, ammo: "Патроны 12шт/48$", image: "/images/ak.png" },
      { name: "Bullpup Rifle", price: 34000, ammo: "Патроны 12шт/48$", image: "/images/bullpup-rifle.png" },
      { name: "HK G36", price: 35000, ammo: "Патроны 12шт/48$", image: "/images/hk-g36.png" },
      { name: "TAR-21", price: 35000, ammo: "Патроны 12шт/48$", image: "/images/tar-21.png" },
      { name: "АКСУ", price: 36000, ammo: "Патроны 12шт/48$", image: "/images/aksu.png" },
      { name: "HK G36 MKII", price: 39000, ammo: "Патроны 12шт/48$", image: "/images/hk-g36-mkii.png" },
      { name: "M4 A1", price: 33000, ammo: "Патроны 12шт/48$", image: "/images/m4-a1.png" },
    ],
  },
]
